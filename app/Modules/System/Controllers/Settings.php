...
class Settings extends Controller {
   ...
   protected function before() {
      ...
      // Setup breadcrumb 
      View::share('breadcrumb', Config::get('system::menu.breadcrumb'));
   }
   ...
   public function index() {
      ...
      $options = array(
         ...
         'siteSkin' => Input::old('siteSkin', Config::get('app.colorScheme')),
         // The Mailer
      ...
      return $this->getView()
            ...
            ->shares('menu', Config::get('system::menu.main'))
            ->withOptions($options);
   }
   ...
   public function store() {
      ...
      if ($validator->passes()) {
         ...
         Option::set('app.colorScheme', $input['siteSkin']);
         ...
         return Redirect::to('settings')->withStatus($status);
      }
