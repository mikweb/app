...
return array(
   ...
   'The Settings are not available while the Config Store is on Files Mode.' => 'Indstillingerne er ikke tilgængelige når "<i>Config Store</span>" er i "<i>Files Mode</span>".',
